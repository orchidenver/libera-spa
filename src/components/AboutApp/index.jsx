      ...
      <div className={`${styles.container} ${styles.row}`}>
        <div className={styles["app__info"]}>
          ...
          <p className={styles["app__text"]}>
            Our easy-to-use POS and order management system aggregates data
            directly from brands and distributors, ensures competitive prices
            and thus better margins. Libera is allowing small entrepreneurs to
            take advantage of their sales data and increase their take home by
            up to 100%. Thanks to constantly expanding assortment, we provide
            store owners with an opportunity to scale their business
          </p>
